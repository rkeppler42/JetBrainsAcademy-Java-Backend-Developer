...
This repository contains all the projects I’ve completed as part of the [Java Backend Developer (Spring Boot) course](https://hyperskill.org/courses/12-java-backend-developer-spring-boot) on JetBrains Academy (Hyperskill).

> **Note:** To earn the certification for this course, I must complete at least **95% of the topics**, apply **95% of the core topics** through project stages, and finish **one graduate project**.  
> Graduate projects are marked accordingly.

> 📌 The final version of each project reflects only the **last stage's implementation**.  
...
> 🧪 Beta projects are marked with this icon next to their title.
...
- ⏳ Encryption-Decryption (Java): _Not Started_
